...
starProgramDetails:
  - number: "1"
    ...
    authors: "Xingyu Ni, Yuechen Zhu, Ruicheng Wang, and Bin Wang"
  - number: "2"
    title: "Advances in Neural 3D Mesh Texturing: A Survey (STAR1000)"
    authors: "Sai Raj Kishore Perla, Hao (Richard) Zhang, and Ali Mahdavi-Amiri"
  - number: "3"
  ...
  - number: "6"
    title: "Non-Rigid 3D Shape Correspondences: From Foundations to Open Challenges and Opportunities (STAR1012)"
    authors: "Aleksei Zhuravlev, Lennart Bastian, Dongliang Cao, Nafie El Amrani, Paul Roetzer, Viktoria Ehm, Riccardo Marin, Hiroki Nishizawa, Shigeo Morishima, Christian Theobalt, Nassir Navab, Daniel Cremers, Florian Bernard, Zorah Lähner, and Vladislav Golyanik"
  - number: "7"
    slotNote: "Invited STARs - 45 min each"
    title: "Deep Sketch-Based 3D Modeling: A Survey"
    doi: "https://doi.org/10.1111/cgf.70302"
    authors: "Alberto Tono, Jiajun Wu, Gordon Wetzstein, Iro Armeni, Hariharan Subramonyam, James Landay, and Martin Fischer"
  - number: "8"
    title: "A Survey of Inter-Prediction Methods for Time-Varying Mesh Compression"
...
tutorialProgramDetails:
  - number: "1"
    ...
    authors: "Fabian Löschner, Stefan Rhys Jeske, José Antonio Fernández-Fernández, and Jan Bender"
  - number: "2"
    title: "A Hands-On Introduction to Discrete Differential Operators on Polygon Meshes"
    authors: "Sven Dominik Wagner, Astrid Bunge, and Mario Botsch"
  - number: "3"
    title: "Deep Learning on Meshes and Point Clouds"
    authors: "Ruben Wiersma"
  - number: "4"
    title: "Optimal Transport for Fluid Simulation New and Old"
    authors: "Cyprien Plateau--Holleville and Bruno Lévy"
  - number: "5"
    title: "Fast Explicit 3D Reconstructions and How To Use Them"
    authors: "Bernhard Kerbl, Markus Steinberger, Linus Franke, Florian Hahlbohm, and Andrea Tagliasacchi"
  - number: "6"
    title: "Effective User Studies in Computer Graphics: From Pixels to Perception"
    authors: "Daniel Martin, Martin Weier, Piotr Didyk, Mauricio Flores-Vargas, Ernst Kruijff, Rachel McDonnell, and Sandra Malpica"
  - number: "7"
    title: "Convex Optimization in Computer Graphics"
    authors: "Leticia Mattos Da Silva"
  - number: "8"
    title: "Introduction to Optimization Time Integration for Solids and Fluids"
    authors: "Jiayi Eris Zhang and Minchen Li"
...
speakers: 
  ...
  - name: Bernd Bickel
    ...
    bio: "Bernd Bickel is a Full Professor of Computational Design at ETH Zurich and a Research Scientist at Google. He previously served as a Professor and Vice President at ISTA and worked as a Research Scientist at Disney Research. He received his PhD in Computer Science from ETH Zurich in 2010. His research intersects visual computing, digital fabrication, and machine learning, focusing on computational tools that bridge digital design and physical manufacturing. His work includes high-fidelity performance capture, data-driven material modeling, functional metamaterials, and creative AI & generative design, integrating physics-based simulation with machine learning to create high-performance structures and systems. Bernd’s contributions have been recognized with a Technical Achievement Award from the Academy of Motion Picture Arts and Sciences (2019), the ACM SIGGRAPH Significant New Researcher Award (2017), an ERC Starting Grant (2016), and the ETH Medal (2011) for his doctoral dissertation."
