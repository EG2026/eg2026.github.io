...
**At least one author needs to register and present in-person their paper**. Participants of Eurographics 2026 will be able to attend presentations of the latest advances in computer graphics and imaging from the research and industry experts. To get an overview over all Eurographics 2026 publications, and in addition to the standard paper presentations, there will be fast forward sessions where each accepted paper is briefly presented. Eurographics is also going to be a great opportunity to meet with international researchers in the domain and socialize around the conference social events. Please check out the conference's in-person presentation policy [here](https://eg2026.github.io/presentation_policy/#presentation_policy).
